...
export function SleepWeeklyChartComponent({ rawData }: SleepDefaultChartProps) {
    ...
    if (ctx) {
      chartRef.current = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Weekly sleep data (last 52 weeks)",
              data,
              fill: false,
...
export default SleepWeeklyChartComponent;
