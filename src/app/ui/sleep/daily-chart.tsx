...
export function SleepDailyChartComponent({ rawData }: SleepDefaultChartProps) {
    ...
    if (ctx) {
      chartRef.current = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Daily sleep data (last 30 days)",
              data: sortedData.map((entry) => entry.hour),
              fill: false,
...
export default SleepDailyChartComponent;
